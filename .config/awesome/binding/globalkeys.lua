...
function _M.get()
  local globalkeys = gears.table.join(
	...
	awful.key({ modkey, "Shift" }, "m", function () awful.spawn.with_shell(RC.vars.lock_screen) end), 
	awful.key({ }, "XF86MonBrightnessUp", function () brightness_widget:inc() end, {description = "increase brightne		ss", group = "custom"}),
	awful.key({ }, "XF86MonBrightnessDown", function () brightness_widget:dec() end, {description = "decrease bright		ness", group = "custom"}),

	awful.key({}, "XF86AudioRaiseVolume", function () 
		local command = "pactl set-sink-volume @DEFAULT_SINK@ +5%"
	...
	awful.key({modkey, }, "e", function () awful.spawn("/bin/thunar")  end),
